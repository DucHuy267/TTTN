  ...
  return (
    <div className="containers">
      <div className="container">
        ...
        <div className="right">
        <h2 style={{ fontWeight: 'bold' }}>Let Us Know You!</h2>
          <form onSubmit={handleRegisterClick}>
            ...
            <div className="form-group">
              ...
              <Input.Password id="password" placeholder="Enter Password" required style={{ height: '40px', width:'300px' }} onChange={handleChange} />
            </div>
